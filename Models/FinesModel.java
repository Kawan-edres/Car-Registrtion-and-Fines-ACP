...
public class FinesModel implements Serializable {
  ...
  public FinesModel(
    String carType,
    Integer carPlateNumber,
    String annualNumber,
    Date finesHistoryDate,
    String typeOfTrafficViolation,
    Double amountOfTrafficViolationMoney,
    Integer totalNumberOfTrafficViolation,
    Double totalAmountOfTrafficViolationMoney
  ) {
    ...
    this.totalAmountOfTrafficViolationMoney =
      totalAmountOfTrafficViolationMoney;
  }
  ...
  public void setAmountOfTrafficViolationMoney(
    Double amountOfTrafficViolationMoney
  ) {
    this.amountOfTrafficViolationMoney = amountOfTrafficViolationMoney;
  }
  ...
  public void setTotalNumberOfTrafficViolation(
    Integer totalNumberOfTrafficViolation
  ) {
    this.totalNumberOfTrafficViolation = totalNumberOfTrafficViolation;
  }
  ...
  public void setTotalAmountOfTrafficViolationMoney(
    Double totalAmountOfTrafficViolationMoney
  ) {
    this.totalAmountOfTrafficViolationMoney =
      totalAmountOfTrafficViolationMoney;
  ...
  public boolean equals(Object o) {
    ...
    return (
      Objects.equals(getCarType(), model.getCarType()) &&
      Objects.equals(getCarPlateNumber(), model.getCarPlateNumber()) &&
      Objects.equals(getAnnualNumber(), model.getAnnualNumber()) &&
      Objects.equals(getFinesHistoryDate(), model.getFinesHistoryDate()) &&
      Objects.equals(
        getTypeOfTrafficViolation(),
        model.getTypeOfTrafficViolation()
      ) &&
      Objects.equals(
        getAmountOfTrafficViolationMoney(),
        model.getAmountOfTrafficViolationMoney()
      ) &&
      Objects.equals(
        getTotalNumberOfTrafficViolation(),
        model.getTotalNumberOfTrafficViolation()
      ) &&
      Objects.equals(
        getTotalAmountOfTrafficViolationMoney(),
        model.getTotalAmountOfTrafficViolationMoney()
      )
    );
  }
